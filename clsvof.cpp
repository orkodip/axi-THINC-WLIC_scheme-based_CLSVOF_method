...
class CLSVOF:public MBASE
{
	...
	void adv_X();	//solve the advection equation (r direction followed by y direction)
	void adv_Y();	//solve the advection equation (y direction followed by r direction)
